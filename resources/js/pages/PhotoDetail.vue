...
export default {
  ...
  methods: {
    ...
    async like () {
      const response = await axios.put(`/vuesplash/api/photos/${this.id}/like`)
    ...
    async unlike () {
      const response = await axios.delete(`/vuesplash/api/photos/${this.id}/like`)
    ...
    async fetchPhoto () {
      const response = await axios.get(`/vuesplash/api/photos/${this.id}`)
      if (response.status !== OK) {
        this.$store.commit('error/setCode', response.status)
        return false
      }
    ...
    async addComment () {
      const response = await axios.post(`/vuesplash/api/photos/${this.id}/comments`, {
